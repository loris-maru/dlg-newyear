...
(a2a_config.vars = {
  ...
  (a2a_config.static_server =
    a2a_config.static_server || "https://static.addtoany.com/menu");
var a2a = a2a || {
  ...
  canonical_url: (function() {
    ...
    return a
      ? a.content
      : !!(e = document.querySelector('link[rel="canonical"]')) && e.href;
  })(),
  ieo: function() {
    for (
      var e = -1, a = document.createElement("b");
      (a.innerHTML = "\x3c!--[if gt IE " + ++e + "]>1<![endif]--\x3e"),
        +a.innerHTML;
  ...
  is_mobile:
    ...
    ("screen" in window && window.screen.width < 1366),
  has_menter:
    document.documentElement && "onmouseenter" in document.documentElement,
  ...
  init: function(e, a) {
    ...
    if ((n = l.target))
      if ("string" == typeof n) {
        if (((i = n.substr(0, 1)), (o = n.substr(1)), "." == i))
          return (
            a2a.multi_init(
              a2a.HTMLcollToArray(a2a.getByClass(o, document)),
              e,
              a
            ),
            void (l.target = !1)
          );
        0 <= (t = (s = a2a.gEl(o)).className).indexOf("a2a_kit") &&
          t.indexOf("a2a_target") < 0 &&
          (s = null);
      } else s = l.target;
    (e = l.menu_type ? "mail" : e) && ((a2a.type = e), l.vars.process()),
      ...
      (c.linkname_implicit =
        !l.linkname_escape && (document.title || d) == c.linkname),
      ...
      "custom" == l.track_links &&
        ((l.track_links = !1), (l.track_links_key = "")),
      ...
      (function(e, a) {
        ...
        i
          ? (e.linkname_escape &&
            ...
            "textContent" in document
              ? (o.textContent = e.linkname)
              : (o.innerText = e.linkname),
  ...
  kit: function(o, e) {
    var a,
      ...
      d = function(e, a) {
        if (e && !a2a.in_array(e, s))
          for (
            var t = 0,
              n = a
                ? a2a[p].services.most.concat(a2a[p].services.email)
                : a2a.services,
              i = n.length;
            t < i;
            t++
      ...
      T =
        (B && A(o.linkmedia).replace(/'/g, "%27"),
        v["a2a-icon-color"] || a2a.c.icon_color),
      F = T ? T.split(",", 2) : T,
      L = F ? F[0] : F,
      N = F ? F[1] : F,
    ...
    D &&
      ...
      (a2a.kit.facebook_like = function() {
        ...
        var e,
          ...
          n,
          i = a2a.i18n();
        for (var o in (2 == (i = i ? i.replace(/-/, "_") : "en_US").length &&
          (i += "_" + i.toUpperCase()),
        pe))
          ue += " data-" + o + '="' + pe[o] + '"';
        window.fbAsyncInit ||
      ...
      (a2a.kit.twitter_tweet = function() {
        ...
        for (var s in ((r.className = "twitter-share-button"), pe))
                ...
                if (l && "tweet" == l.region) {
                  var e = (function() {
                    ...
                    if (e && -1 < e.indexOf("url=")) {
                      for (
                        var a = {}, t = e.split("&"), n = t.length, i = 0;
                        i < n;
                        i++
                      ) {
                        var o = t[i].split("=");
      ...
      (a2a.kit.pinterest_pin = function() {
        ...
        "beside" == pe["pin-config"] &&
          ...
          (n.href =
            ...
            (pe.description
              ? "&description=" +
                encodeURIComponent(pe.description).replace(/'/g, "%27")
              : "")),
      ...
      if (K)
        ...
        a2a.add_event(V, "mouseenter", function() {
          (a2a.gEl("a2a_modal").style.willChange = "transform, opacity"),
            (a2a.gEl("a2a_overlay").style.willChange =
        ...
        if (
                ...
                (function(r, s, c, d, u) {
                  return function(e) {
                    ...
                    (t = !(!(a = f(s, u, e)) || !a.stop)),
                      ...
                      (!u.a2a.externalJS && !u.a2a.literalJS) ||
                        t ||
                        n ||
                        a2a.runJS(u.a2a),
          ...
          for (var me, fe, _e, ge = 0, he = Z.length; ge < he; ge++)
            if (
              ...
              1 == Z[ge].nodeType &&
                (_e || (G = !0), fe && 0 <= me.indexOf("a2a_count")))
            ) {
              q = !0;
              break;
            }
          if (!G) {
            for (var ve in (((U = document.createElement("span")).className =
              M + ie + " a2a_img_text"),
          ...
          V.appendChild(U),
            ...
            (U.innerHTML =
              ae ||
              ("feed" == p ? a2a.c.localize.Subscribe : a2a.c.localize.Share)),
            ae ||
    ...
    0 <= y.indexOf("a2a_default_style") &&
      ((x.style.clear = "both"), h.appendChild(x));
  },
  counters: {
    ...
    function o(e, a, t, n) {
      ...
      if (a2a.matches(m, n) && "false" !== m.getAttribute("data-a2a-overlay")) {
        if (
          ...
          (r =
            "naturalWidth" in m && (m.naturalWidth < k || m.naturalHeight < k)),
          l || r)
        )
          return;
        ...
        (o = a2a.getPos(m, "scroll")),
          ...
          t[0] &&
            ("bottom" === t[0]
              ? (g = m.height - s)
              : "center" === t[0] && (g = x((m.height - s) / 2))),
          t[1] &&
            ("right" === t[1]
              ? (_ = m.width - c)
              : "center" === t[1] && (_ = x((m.width - c) / 2))),
          (d = o.left + _),
          (u = o.top + g),
          (a.style.left = d + "px"),
          (a.style.top = u + "px"),
  ...
  unindexed: function(o, e) {
    var a = document,
      ...
      n = t("a2a_kit", a),
      i = a2a
        .HTMLcollToArray(a.getElementsByName("a2a_dd"))
        .concat(t("a2a_dd", a));
    function l(e) {
  ...
  defaultPrevented: function(e) {
    return !!(
      e.defaultPrevented ||
      !1 === e.returnValue ||
      ("undefined" == typeof e.defaultPrevented &&
        e.getPreventDefault &&
        e.getPreventDefault())
    );
  },
  ...
  getData: function(e) {
    ...
    for (var a, t = 0, n = e.attributes.length, i = {}; t < n; t++)
      (a = e.attributes[t]).name &&
        "data-" == a.name.substr(0, 5) &&
        (i[a.name.substr(5)] = a.value);
    return i;
  },
  ...
  getPos: function(e, a) {
    var t,
      n = Math.round,
      i =
        (a2a.getScrollDocDims, "scroll" === a ? a2a.getScrollDocDims("w") : 0),
  ...
  do_find: function() {
    ...
    if ("" !== i) {
      e = i.split(" ");
      for (var l = 0; l < n; l++)
        o(t[l].a2a.serviceNameLowerCase, e, !1)
          ? (t[l].style.display = "")
  ...
  selection: function(e) {
    ...
    if (a && "" !== a) return a;
    if (
      a2a["n" + a2a.n].linkurl === location.href &&
  ...
  collections: function(e) {
    var a = a2a.gEl,
      t = a2a[e],
      n = "a2a" + e;
    (t.main_services_col_1 = a2a.getByClass(
      "a2a_i",
      a(n + "_full_services"),
      "a"
    )),
  ...
  linker: function(e) {
    var a,
      ...
      l =
        a2a[
          "n" +
            (o.a2a_index || o.parentNode.a2a_index || a2a.sole_index || a2a.n)
        ],
      r = l.type,
      s = e.a2a.safename,
      ...
      g =
        !l.track_links || ("page" != r && "mail" != r)
          ...
          : "&linktrack=" +
            l.track_links +
            "&linktrackkey=" +
            encodeURIComponent(l.track_links_key),
    ...
    if (w && f) (e.a2a.js_skip = 1), (e.target = "_blank");
      ...
      (e.target = ""),
        "javascript:" == y.substr(0, 11)
          ? ((t = y.replace("${link}", c.replace(/'/g, "\\'"))),
            (e.a2a.literalJS = t.substr(11)))
          : (e.a2a.externalJS = y),
        (a = "#" + s);
  ...
  overlay: {
    show: function() {
      ...
      "none" === a2a.getStyle(t, "display") &&
        (a2a.animate("show", t),
        (a2a.overlay.key_listener = a2a.add_event(document, "keydown", function(
          e
        ) {
    ...
    (a2a.show_full.full_shown = !1),
      ...
      a2a.overlay.hide(function l() {
        (i.style.display = o.style.display = "none"),
          ...
          a2a.isDisplayed(a(t + "_dropdown")) &&
            a(t + "_show_more_less").focus();
      });
  },
  show_modal: function() {
    a2a.type;
    for (
      var e = a2a.gEl,
        a = (e("a2a_overlay"), e("a2a_modal")),
        t = a2a.getByClass("a2a_modal_body", a),
        n = 0;
      n < t.length;
      n++
    )
  ...
  show_full: function() {
    ...
    a2a.fill_menus(e),
      ...
      l.style.height.length &&
        (l.style.height =
          "calc(100% - " + (o.offsetHeight + r.offsetHeight) + "px)"),
      i.focus(),
      a2a.stats("full");
  },
  show_menu: function(e, a) {
    ...
    a2a.fill_menus(_),
        ...
        ((a2a[_].doc_click_close_mini =
          ...
          function(e) {
            (!a2a.ieo() && "number" == typeof e.button && 0 < e.button) ||
              (a2a[_].last_focus && a2a[_].last_focus.focus(),
              a2a.toggle_dropdown("none", m));
          })),
      ...
      (a2a.show_menu.key_listener[_] = a2a.add_event(
        document,
        "keydown",
        function(e) {
  ...
  fill_menus: function(e) {
    if (
      ((a2a.fill_menus.a2a = a2a.fill_menus.a2a || {}), !a2a.fill_menus.a2a[e])
    ) {
      var a,
        t,
        n = "a2a" + e,
      ...
      if ("mail" != e) {
        for (
          ...
          (g && a2a.in_array(h[1], g, !0)) ||
            l.appendChild(o(h[0], h[1], h[2], h[3], h[4])),
            !(_ < f) ||
              (g && a2a.in_array(h[1], g, !0)) ||
              (r.appendChild(o(h[0], h[1], h[2], h[3], h[4])), _++);
        }
        i(n + "_full_services").appendChild(l),
          i(n + "_mini_services").appendChild(r);
      }
      ...
      for (var v = s.email, y = v.length; u < y; u++) {
        h = v[u];
        (g && a2a.in_array(h[1], g, !0)) ||
          i(n + "_2_col1").appendChild(o(h[0], h[1], h[2], h[3], h[4]));
      }
      a2a.arrange_services(),
        ...
        "mail" != e &&
          (c.onkeydown = function(e) {
            ...
            if (13 == a) {
              for (
                var n, i = 0, o = a2a[t].main_services, l = o.length;
                i < l;
                i++
              )
              ...
              27 == a &&
                ("" == c.value && c.blur(), (c.value = ""), a2a.do_find());
          }),
            ...
            document.execCommand &&
              ...
              setTimeout(function() {
                (n.style.display = i.style.display = o.style.display = "none"),
                  a2a.show_full.full_shown
                    ? a2a.show_full()
                    : a2a.hide_modals("page");
              }, 700));
        }),
        ...
        a.removeEventListener(n, r),
          ...
          (function p(e) {
            ...
            d || (((d = m.createElement("div")).id = c), s.appendChild(d)),
              (d.innerHTML = ""),
              ((a = m.createElement("div")).className =
  ...
  ads: {
    lit: function() {
      var e = a2a_config.thanks;
      return !(
        (a2a.gEl("wpadminbar") || ("undefined" != typeof wp && wp.customize)) &&
        (!e || !e.postShare)
      );
    },
    has: function(e) {
          ...
          : e &&
            (function p() {
              ...
              r && (r.style.display = "none"),
                l
                  ? window.postMessage &&
                    i("a2a_thanks_ifr").contentWindow.postMessage(
                      "a2a_refresh_slot1",
                      "*"
                    )
                  : ((function n() {
                    ...
                    ((e = document.createElement("iframe")).id =
                      "a2a_thanks_ifr"),
        ...
        if ("function" == typeof urchinTracker)
          a2a.GA.track = function(e, a, t, n, i) {
            urchinTracker("/addtoany.com/" + n),
              urchinTracker(
                "/addtoany.com/" + n + "/" + (t || a2a["n" + a2a.n].linkurl)
              ),
          ...
          "string" == typeof GoogleAnalyticsObject &&
        ...
        (a2a.add_event(window, "message", function(e) {
          if (".addtoany.com" === e.origin.substr(-13)) {
            var a = "string" == typeof e.data ? e.data.split("=") : [""],
              ...
              i = t.substr(0, 4);
            if (
              ((a2a.c.http_s = "s"), -1 === ["page", "feed", "mail"].indexOf(i))
            )
              return;
            t == i + "_services" &&
              ((n = "" != n && n.split(",")),
    ...
    if (e && e < 9) {
      ...
      for (
        var n,
          ...
          l,
          r = 0,
          s = a2a.getByClass("a2a_svg", document),
          c = s.length;
        r < c;
        r++
      )
  ...
  css: function() {
    ...
    (e =
      ...
      i.styleSheet
        ...
        : ((a = document.createTextNode(e)), i.appendChild(a));
  },
  svg_css: function() {
    a2a.init("page");
  ...
  svg: {
    ...
    get: function(e, a, t) {
      ...
      return (
        ...
        svg_src
          ? ((svg_src = t ? i(svg_src, t) : svg_src),
            svg_tag_open + svg_src + svg_tag_close)
          : svg_src_default
    ...
    loadCSS: function(e) {
      ...
      (o.rel = "stylesheet"),
        (o.href =
          l +
          ["icons.29.svg.css", "icons.29.png.css", "icons.29.old.css"][
            e && i ? 0 : e ? 1 : 2
          ]),
  ...
  localize: function() {
    ...
    for (var o, l, r, s, c, d = 0, u = e.length; d < u; d++)
      (l = (l = (o = e[d]).getAttribute("data-a2a-localize"))
        ? l.split(",", 2)
        : l) &&
        ((s = l[0]),
        (c = a[(r = l[1])] || t[r] || ""),
        ...
        (a2a["create_" + a2a.type + "_html"] = function(e, a) {
          ...
          if (
            ...
            (x = u.localize = {
              ...
              FindAnyServiceToAddTo:
                x.FindAnyServiceToAddTo || b.FindAnyServiceToAddTo,
              ...
              BookmarkInYourBrowser:
                x.BookmarkInYourBrowser || b.BookmarkInYourBrowser,
              BookmarkInstructions:
                x.BookmarkInstructions || b.BookmarkInstructions,
              AddToYourFavorites: x.AddToYourFavorites || b.AddToYourFavorites,
              SendFromWebOrProgram:
                x.SendFromWebOrProgram || b.SendFromWebOrProgram,
            ...
            var A = "a2a_menu_container",
              E = s(A);
            o = a2a.html_container =
              E && !a2a.init_show.a2a_done ? E : document.createElement("div");
          ...
          o.id != A &&
            ...
            (n = s(d + "_dropdown")) &&
              ...
              a2a[c].onclick ||
                a2a.add_event(n, "mouseleave", a2a.miniLeaveDelay)),
            (t = s(d + "_find")) &&

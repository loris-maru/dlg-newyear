!(function(t, e) {
  "object" == typeof exports && "object" == typeof module
    ...
    ? (exports.VueSocialSharing = e())
    : (t.VueSocialSharing = e());
      ...
      var n = {
        ...
        computed: {
          ...
          shareLink: function() {
            ...
            return (
              "twitter" === this.key &&
                (this.hashtags.length || (t = t.replace("&hashtags=@h", "")),
        ...
        render: function(t) {
          ...
          var i = {
            ...
            on: {
              click: function() {
                return e[
                  "http" === e.rawLink.substring(0, 4) ? "share" : "touch"
                ]();
              },
            },
          };
          return (
            "a" === this.tag && (i.attrs = { href: "#" }),
